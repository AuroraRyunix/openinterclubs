...
#     E.g.: docker.io/hexpm/elixir:1.18.1-erlang-25.3.2.15-debian-trixie-20260610-slim
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/openinterclubs ./
